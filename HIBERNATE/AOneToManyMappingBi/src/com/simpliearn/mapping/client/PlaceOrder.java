package com.simpliearn.mapping.client;
...
public class PlaceOrder {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Order o1= new Order(1,new Double(100.0), new Date(),"New"); 
			session.save(o1);
			
			Order o2= new Order(2,new Double(200.0), new Date(),"New"); 
			session.save(o2);
			
			Order o3= new Order(3,new Double(300.0), new Date(),"New"); 
			session.save(o3);
